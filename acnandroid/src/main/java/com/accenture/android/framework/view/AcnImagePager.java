...
public class AcnImagePager extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            //INDICATOR COLOR
            this.selectedIndicatorColor = a.getColor(R.styleable.AcnImagePager_selectedIndicatorColor, getResources().getColor(android.R.color.black));
            this.unselectedIndicatorColor = a.getColor(R.styleable.AcnImagePager_unselectedIndicatorColor, getResources().getColor(android.R.color.darker_gray));
            ...
            this.selectedIndicatorSize = (int) a.getDimension(R.styleable.AcnImagePager_selectedIndicatorSize, eightDpInPixels);
            this.unselectedIndicatorSize = (int) a.getDimension(R.styleable.AcnImagePager_unselectedIndicatorSize, sixDpInPixels);
        ...
        this.pagerIndicator = (PagerIndicator) view.findViewById(R.id.pagerIndicator);
